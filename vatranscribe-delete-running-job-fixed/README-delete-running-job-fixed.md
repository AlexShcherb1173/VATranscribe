...
- Если backend всё-таки вернул ошибку, frontend показывает detail из API, а не общий текст "Запрос не выполнен".

Проверка:

cd D:\DevProject\PythonProject\VATranscribe\apps\web
npm run dev
