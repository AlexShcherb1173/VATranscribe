...
from apps.api.app.models import Job, JobLog, JobStatus, JobType, SourceType
...
def analyze_download_url(payload: DownloadAnalyzeRequest) -> DownloadAnalyzeResponse:
    try:
...
def create_download_job(payload: DownloadJobCreateRequest) -> JobResponse:
